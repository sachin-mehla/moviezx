...
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", '📂 <em>File Name</em>: <code>@sachinXmehla|{file_name}</code> \n\n🖇 <em>File Size</em>: <code>{file_size}</code> \n\n\n❤️‍🔥 </i>Join</i> [Sachin Mehla ;)](https://t.me/sachinXmehla)  \n\n⚔️ <i>Request Movies</i> - ||@moviesX11_bot|| \n\n')
BATCH_FILE_CAPTION = environ.get("BATCH_FILE_CAPTION", '📂 <em>File Name</em>: <code>Sachin Mehla|{file_name}</code> \n\n🖇 <em>File Size</em>: <code>{file_size}</code> \n\n\n❤️‍🔥 </i>Join</i> [Sachin Mehla ;)](https://t.me/sachinXmehla)  \n\n⚔️ <i>Request Movies</i> - ||@moviesx11_bot|| \n\n')
