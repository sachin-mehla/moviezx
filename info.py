...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001805539468 -1001726863824').split()]
...
DATABASE_NAME = environ.get('DATABASE_NAME', "ror")
...
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", '♦️ <em>ꜰɪʟᴇ ɴᴀᴍᴇ</em>: <code>@sachinXmehla</code> | {file_name} \n\n♦️ <em>ꜰɪʟᴇ ꜱɪᴢᴇ</em>: {file_size} \n\n♦️ ᴜᴘʟᴏᴀᴅᴇᴅ ʙʏ @moviezXrobot  \n\n♦️ <i>Request Movies</i> - ||@moviesX11_bot|| \n\n')
BATCH_FILE_CAPTION = environ.get("BATCH_FILE_CAPTION", '♦️ <em>ꜰɪʟᴇ ɴᴀᴍᴇ</em>: <code>@sachinXmehla</code> | {file_name} \n\n♦️ <em>ꜰɪʟᴇ ꜱɪᴢᴇ</em>: {file_size} \n\n♦️ ᴜᴘʟᴏᴀᴅᴇᴅ ʙʏ @moviezXrobot   \n\n♦️ <i>Request Movies</i> - ||@moviesx11_bot|| \n\n')
